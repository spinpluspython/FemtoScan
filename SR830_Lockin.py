...
class SR830(Lockin.Lockin):
    """ Instrument class to control the Lock-In Amplifier SR830"""
    ...
    def connect(self):
        ...
        try:
            ...
            self.sendCommand(
                '++eos 2')  # sets up the terminator <lf> wich will be added to every command for Lockin, this is only for GPIB connetction
