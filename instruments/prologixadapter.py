...
modified from: https://github.com/pyvisa/pyvisa/issues/112#issuecomment-107023515
...
if __name__ == '__main__':
    ...
    myPrologicInst = ScpiInstrumentWrapper('PROLOGIX::COM12::GPIB::20')
    myLanVisaInst = ScpiInstrumentWrapper('TCPIP::192.168.4.103')
    print(myPrologicInst.query('*IDN?'))
    print(myLanVisaInst.query('*IDN?'))